  ...
  const calculateValue = (tDayEndMax) => {
    ...
    for (let i = 0; i < completeData.length; i++) {
      if (
        ...
        let highStockCeValueCheck = completeData[i][ceValue.value].stockHigh
          ? completeData[i][ceValue.value].stockHigh
          : completeData[i][ceValue.value].stockClose;
        let highStockPeValueCheck = completeData[i][peValue.value].stockHigh
          ? completeData[i][peValue.value].stockHigh
          : completeData[i][peValue.value].stockClose;
        ...
        if (tmpCeValueChange < ceSlTrigger.value) {
        ...
        if (tmpPeValueChange < peSlTrigger.value) {
